...
public:
	...
	typedef pair<time_t, pair<string, Severity>> Pair;
	...
	void message(const string& msg, Severity severity = LOG_INFO);
...
/**
 * @file
 * $Id: LogManager.h 562 2011-01-09 12:54:12Z bigmuscle $
 */
