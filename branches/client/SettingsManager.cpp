...
SettingsManager::SettingsManager()
{
	...
	setDefault(TRANSFER_SPLIT_SIZE, 200);
...
// TODO:	setDefault(TOOLBAR_SIZE, 800);
	...
	setDefault(MAIN_WINDOW_STATE, -1);
	setDefault(MAIN_WINDOW_SIZE_X, -1);
	setDefault(MAIN_WINDOW_SIZE_Y, -1);
	setDefault(MAIN_WINDOW_POS_X, -1);
...
/**
 * @file
 * $Id: SettingsManager.cpp 559 2010-12-30 23:57:56Z bigmuscle $
 */
