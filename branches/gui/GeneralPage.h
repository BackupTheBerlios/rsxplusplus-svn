...
private:
	...
	wxStaticText* descrLabel;
	wxTextCtrl* descrEdit;
	wxStaticText* speedLabel;
	wxComboBox* speedCombo;
	wxStaticText* mbitLabel;
...
public:
	GeneralPage(wxWindow* parent, SettingsManager *s);
	~GeneralPage();

	void write();
};

#endif // _GENERALPAGE_H
