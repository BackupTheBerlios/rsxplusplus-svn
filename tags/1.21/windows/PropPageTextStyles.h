...
public:
	...
	BEGIN_MSG_MAP_EX(PropPageTextStyles)
		...
		COMMAND_HANDLER(IDC_SELECT_STYLES, LBN_SELCHANGE, onSelectStylesChange) //RSX++
	...
	LRESULT onSelectStylesChange(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/); //RSX++
...
protected:
	...
	enum TextStyles {
		TS_GENERAL, TS_MYNICK, TS_MYMSG, TS_PRIVATE, TS_SYSTEM, TS_SERVER, TS_TIMESTAMP, TS_URL, TS_FAVORITE, TS_OP, TS_PROTECTED,
	TS_LAST };
