...
const string SettingsManager::settingTags[] =
{
	...
	"BeepFile", "BeginFile", "FinishedFile", "SourceFile", "UploadFile", "FakerFile", "ChatNameFile", 
...
SettingsManager::SettingsManager()
{
	...
	setDefault(WEBSERVER_USER, "rsxplusplus");
	setDefault(WEBSERVER_PASS, "rsxplusplus");
...
/**
 * @file
 * $Id: SettingsManager.cpp 487 2010-02-27 17:50:12Z bigmuscle $
 */
