...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		BEEPFILE, BEGINFILE, FINISHFILE, SOURCEFILE, UPLOADFILE, FAKERFILE, CHATNAMEFILE,
		...
		TOOLBAR, TOOLBARIMAGE, TOOLBARHOTIMAGE, USERLIST_IMAGE, //76
		...
		UPDATE_URL, SOUND_TTH, SOUND_EXC, SOUND_HUBCON,  SOUND_HUBDISCON, SOUND_FAVUSER, SOUND_TYPING_NOTIFY,
 		WEBSERVER_FORMAT, WEBSERVER_USER, WEBSERVER_PASS, LOG_FILE_MAIN_CHAT, //91
		LOG_FILE_PRIVATE_CHAT, LOG_FILE_STATUS, LOG_FILE_UPLOAD, LOG_FILE_DOWNLOAD, LOG_FILE_SYSTEM,
		LOG_FORMAT_SYSTEM, LOG_FORMAT_STATUS, LOG_FILE_WEBSERVER, DIRECTORLISTINGFRAME_ORDER, DIRECTORLISTINGFRAME_WIDTHS,
		...
		//RSX++ String settings
		PG_LOG_FORMAT, PG_LOG_FILE, PG_UPDATE_URL, PG_FILE,
		RAW_LOG_FORMAT, RAW_LOG_FILE, BETAUSR, BETAPASS,
		//END
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DEBUG_COMMANDS, AUTO_PRIORITY_DEFAULT, USE_OLD_SHARING_UI, SHOW_DESCRIPTION_SPEED,
		...
		BADSOFT_DETECTIONS, DETECT_BADSOFT, ACCEPTED_DISCONNECTS, ACCEPTED_TIMEOUTS,
		...
		COLOR_RUNNING, COLOR_DOWNLOADED, COLOR_VERIFIED, AUTO_REFRESH_TIME, USE_TLS, OPEN_WAITING_USERS, 
		...
		FILTER_ENTER, SORT_FAVUSERS_FIRST, SHOW_SHELL_MENU, ENABLE_REAL_UPLOAD_QUEUE,
		
		//RSX++
		USE_TRANSPARENT, TRANSPARENT_LEVEL, STEALTHY_STYLE, TOP_SPEED, TOP_UP_SPEED, PROGRESSBAR_ODC_BUMPED,
		STEALTHY_INDICATE_SPEEDS, PG_ENABLE, PG_UP, PG_DOWN, PG_SEARCH, PG_LOG, PROGRESSBAR_MODE,
		SHOW_PLUGIN_TOOLBAR, RAW_CMD_LOG,
		//END
		INT_LAST };
	...
	void set(IntSetting key, int value) {
		...
		//RSX++
		if((key == PROGRESSBAR_MODE) && (value > 3 || value < 0)) {
			value = 2;
		}
		//END
...
/**
 * @file
 * $Id: SettingsManager.h 323 2007-08-19 18:51:47Z bigmuscle $
 */
