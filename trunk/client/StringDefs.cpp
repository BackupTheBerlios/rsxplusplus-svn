...
"Run in background", 
"Statistics", 
"Please wait while RSX++ indexes your files (they won't be shared until they've been indexed)...", 
...
"Check user on join", 
", stated size = %[userSSshort], real size = %[userRSshort]", 
"Checking client...", 
"Choose folder", 
...
"left", 
"Left color", 
"Application ""%s"" caused an unhandled exception in RSX++. Please uninstall it, upgrade it or use an alternate product.", 
"Upload Limit", 
"Listening socket failed (you need to restart RSX++): ", 
"File list loaded.", 
"Loading RSX++, please wait...", 
...
"File Size:", 
"A MAGNET link was given to RSX++, but it didn't contain a valid file hash for use on the Direct Connect network.  No action will be taken.", 
"RSX++ has detected a MAGNET link with a file hash that can be searched for on the Direct Connect network.  What would you like to do?", 
...
"Move &Up", 
"My nick in mainchat", 
"NetLimiter was detected in your computer. It is frequently responsible for RSX++ crash, upload disconnecting and slow download speed. Please uninstall it and use an alternate product, or built-in limiter.", 
"Network Statistics", 
"&New...", 
...
"Remove Forbidden (Unfinished Kazaa, Win MX, GetRight, eMule, RSX++)", 
...
"Don't announce new RSX++ versions (version.xml is still downloaded)", 
...
"Queue", 
"Rename", 
"Note; most of these options require that you restart RSX++", 
"Reset", 
...
"Blocked by PeerGuardian", 
"PeerGuardian not running...", 
"PeerGuardian running with %s IP ranges.", 
"PeerGuardian running but not active.", 
"Stand alone blocking software detected!", 
"Log PeerGuardian activity", 
"PeeerGuardian List Viewer", 
"The list is being loaded, please wait...", 
"The list is empty, or the format is not supported.", 
"Total IP ranges", 
"PeerGuardian Tester", 
...
"Autosearch", 
"Action & Raw", 
"Favorite users are protected", 
"Use send delayed raw", 
"Not check the client of the protected users", 
"No protected users lists check", 
"Detect all clients before downloading filelists", 
"Delete checked filelists", 
"Check the new versions of client profile at startup", 
"Ignore PM Flooder instead of kick", 
"Protect user during PM session", 
"Enable search for forbidden files / TTH", 
"Automatically search every", 
"Use partial file sharing upload (Recommended)", 
"Use Chat Filter on connecting to new hubs", 
"Use Highlight on connecting to new hubs", 
"&Edit", 
...
"Action of the detector", 
"This Raw already exists", 
"No Action", 
"New identical name, cancelled action...", 
"Action", 
"Raw", 
...
"RegExp tester", 
"Client MyInfo", 
"Client profiles now updated.", 
"Already exists, change name please", 
"Client profiles download failed.", 
"New definition of profile available", 
"Updated", 
"Failed", 
"Profile version", 
"Profile Count", 
...
"Clear", 
"Clean User", 
"Your RSX++ client is too old, upgrade it with new version.", 
...
"Value", 
"IP Range", 
"conflicts with an existing range: ", 
"Please enter an ISP", 
"Invalid IP range", 
"First IP must be lower than the second", 
"This range", 
"ISPs now updated.", 
"Not added to ISP list", 
"Isp", 
"Bad", 
"Import favorites", 
"<Search>", 
...
"Download skiplist (wildcards supported, use semicolon to separate entries)", 
...
"Copy Host", 
"Copy CID", 
"It's not a valid RSX++ Plugin!", 
"Failed to load plugin!", 
"Plugin is using too old API revision!", 
};
...
"SettingsFakeshare", 
"SettingsIpPage", 
"SettingsMyinfoDetector", 
"SettingsFilelistDetector", 
"SettingsAutosearch", 
"SettingsActionRaw", 
"SettingsFavUserIsProtectedUser", 
"SettingsUseSendDelayedRaw", 
"SettingsUncheckClientProtectedUser", 
"SettingsUncheckListProtectedUser", 
"SettingsCheckAllClientsBeforeFilelists", 
"SettingsDeleteCheckedFilelists", 
"SettingsGetUpdateProfile", 
"SettingsIgnorePmSpammers", 
"SettingsProtectPmUsers", 
"AutosearchEnable", 
