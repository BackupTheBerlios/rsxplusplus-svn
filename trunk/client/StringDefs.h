...
enum Strings { // @DontAdd
	...
	HASH_PROGRESS_TEXT, // "Please wait while RSX++ indexes your files (they won't be shared until they've been indexed)..."
	...
	LIB_CRASH, // "Application ""%s"" caused an unhandled exception in RSX++. Please uninstall it, upgrade it or use an alternate product."
	LIMIT, // "Upload Limit"
	LISTENER_FAILED, // "Listening socket failed (you need to restart RSX++): "
	LOADED_FILE_LIST, // "File list loaded."
	LOADING, // "Loading RSX++, please wait..."
	...
	MAGNET_DLG_TEXT_BAD, // "A MAGNET link was given to RSX++, but it didn't contain a valid file hash for use on the Direct Connect network.  No action will be taken."
	MAGNET_DLG_TEXT_GOOD, // "RSX++ has detected a MAGNET link with a file hash that can be searched for on the Direct Connect network.  What would you like to do?"
	MAGNET_DLG_TITLE, // "MAGNET Link detected"
	MAGNET_HANDLER_DESC, // "Download files from the Direct Connect network"
	MAGNET_HANDLER_ROOT, // "RSX++"
	...
	MENU_DISCUSS, // "RSX++ Discussion forum"
	MENU_DONATE, // "Donate"
	...
	SETCZDC_REMOVE_FORBIDDEN, // "Remove Forbidden (Unfinished Kazaa, Win MX, GetRight, eMule, RSX++)"
	...
	SETTINGS_BWBOTH, // "Connection type (like old DC++)"
	SETTINGS_BWSINGLE, // "Default (like plain DC++)"
	...
	SETTINGS_DISPLAY_DC_UPDATE, // "Don't announce new RSX++ versions (version.xml is still downloaded)"
	...
	SETTINGS_REQUIRES_RESTART, // "Note; most of these options require that you restart RSX++"
	...
	BEGIN, // "Begin"
	END, // "End"
	PG_BLOCKLIST, // "PeerGuardian Blocklist"
	PG_BLOCKED, // "Blocked by PeerGuardian"
	PG_NOT_RUNNING, // "PeerGuardian not running..."
	PG_RUNNING, // "PeerGuardian running with %s IP ranges."
	PG_RUNNING_IDLE, // "PeerGuardian running but not active."
	PG_ALT_SOFT, // "Stand alone blocking software detected!"
	PG_LOG, // "Log PeerGuardian activity"
	PG_LIST_VIEWER, // "PeeerGuardian List Viewer"
	PG_VIEWER_LOADING, // "The list is being loaded, please wait..."
	PG_VIEWER_EMPTY, // "The list is empty, or the format is not supported."
	PG_RANGE_COUNT, // "Total IP ranges"
	PG_TESTER, // "PeerGuardian Tester"
	PG_TESTER_NO_MATCH, // "This IP is not blocked."
	PG_LIST_OPTIONS, // "Blocklist preferences"
	PG_CURRENT_LIST, // "Current list:"
	PG_UPDATE_LOCATION, // "Update server:"
	...
	VERSION_TOO_OLD, // "Your RSX++ client is too old, upgrade it with new version."
	...
	CONVERT_FAV, // "Import favorites"
	QSEARCH_STR, // "<Search>"
	ADL_POINTS, // "Points"
	ADL_OVERRIDE_POINTS_COLUMN, // "Override points"

	MENU_CHANGE_PRIO, // "Change Priority"
