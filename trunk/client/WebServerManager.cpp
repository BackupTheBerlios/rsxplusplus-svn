...
string WebServerManager::getLoginPage(){
	...
	pagehtml += "<head>";
	pagehtml += "    	<title>RSX++ webserver - Login Page</title>";   
    ...
    pagehtml += "		2007-2008 | adrian_007 | <a href='http://rsxplusplus.sf.net/'>RSX++++</a>";
    pagehtml += "	</div>";
    pagehtml += "</div>";                                
    pagehtml += "</body>";
    pagehtml += "</html>";
...
string WebServerManager::getPage(const string& file, const string& IP) {
    ...
    pagehtml += "<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='cs'>";
    pagehtml += "<head>";
    pagehtml += "    <title>RSX++ webserver</title>";
	...
	switch(page->id){
		case INDEX:
			pagehtml+="Welcome to the RSX++ WebServer";
			break;
    ...
    pagehtml += "	</div>";
    pagehtml += "	<div id='paticka'>";
    pagehtml += "		2007-2008 | adrian_007 | RSX++";
    pagehtml += "	</div>";
    pagehtml += "</div>";
