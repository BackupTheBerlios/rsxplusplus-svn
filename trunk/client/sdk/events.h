...
#define DCPP_HUB_DESTROYED					DCPP_HUB + 5
#define DCPP_HUB_MESSAGE_IN					DCPP_HUB + 6
#define DCPP_HUB_MESSAGE_OUT				DCPP_HUB + 7
#define DCPP_HUB_PRIV_MESSAGE_IN			DCPP_HUB + 8
#define DCPP_HUB_PRIV_MESSAGE_OUT			DCPP_HUB + 9
//Calls
#define DCPP_HUB_OPEN						DCPP_HUB + 10
#define DCPP_HUB_CLOSE						DCPP_HUB + 11
#define DCPP_HUB_REDIRECT					DCPP_HUB + 12
#define DCPP_HUB_FIELD_GET					DCPP_HUB + 13
#define DCPP_HUB_FIELD_SET					DCPP_HUB + 14
#define DCPP_HUB_FIELD_MY_GET				DCPP_HUB + 15
#define DCPP_HUB_FIELD_MY_SET				DCPP_HUB + 16
#define DCPP_HUB_SOCKET_WRITE				DCPP_HUB + 17
#define DCPP_HUB_SEND_MESSAGE				DCPP_HUB + 18
#define DCPP_HUB_SEND_USER_COMMAND			DCPP_HUB + 19
#define DCPP_HUB_WRITE_LINE					DCPP_HUB + 20
