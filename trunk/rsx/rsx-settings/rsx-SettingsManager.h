...
#if !defined(RSX_SETTINGS_MANAGER_H)
...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		UPDATE_URL, UPDATE_ISP_URL, UPDATE_MYINFOS,
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		SHOW_SHARE_CHECKED_USERS, DELETE_CHECKED_FILELISTS, CHECK_CONFLICTS, ISP_CHECKING, USE_POINTS_IN_ADLS, USE_IPWATCH,
		IGNORE_USE_REGEXP_OR_WC, IPUPDATE, SDL_SPEED, SDL_TIME, RAW_SENDER_SLEEP_TIME,
		IGNORE_PM_SPAMMERS, DEFAULT_PRIO,
		...
		BAD_ISP_RAW,					ADL_RAW_LOW_POINTS, 
		ADL_RAW_MEDIUM_POINTS,			ADL_RAW_HIGH_POINTS,
		HASH_ERROR_RAW,					RMDC_RAW, 
		DCPP_EMULATION_RAW,				FILELIST_VERSION_MISMATCH, 
		SDL_RAW,						PM_SPAM_KICK, 
		FAKE_SLOT_COUNT,
		...
		SHOW_BAD_ISP_RAW,				SHOW_ADL_RAW_LOW_POINTS, 
		SHOW_ADL_RAW_MEDIUM_POINTS,		SHOW_ADL_RAW_HIGH_POINTS,
		SHOW_HASH_ERROR_RAW,			SHOW_RMDC_RAW, 
		SHOW_DCPP_EMULATION_RAW,		SHOW_FILELIST_VERSION_MISMATCH, 
		SHOW_SDL_RAW,					SHOW_PM_SPAM_KICK, 
		...
		USE_CHAT_FILTER, PARTIAL_FILE_SHARING, AUTOSEARCH_ENABLED, AUTOSEARCH_ENABLED_TIME, AUTOSEARCH_EVERY,
