...
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
		...
		if(value != 0) //edit value
			ADLSearchManager::getInstance()->removePointSetting(value);
	...
	LRESULT OnCloseCmd(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/) {
		if(wID == IDOK) {
			...
			if(!ADLSearchManager::getInstance()->addPointSetting(value, actionId, display)) {
