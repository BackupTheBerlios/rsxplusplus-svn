...
public:
	...
	BEGIN_MSG_MAP(MainFrame)
		...
		COMMAND_ID_HANDLER(IDC_CHANGE_PRIO_NORMAL, onChangePriority)
		COMMAND_ID_HANDLER(IDC_CHANGE_PRIO_BELOW, onChangePriority)
		COMMAND_ID_HANDLER(IDC_CHANGE_PRIO_IDLE, onChangePriority)
		COMMAND_RANGE_HANDLER(ID_SWINDOW_1, ID_SWINDOW_0, onSwitchWindow)
		//END
