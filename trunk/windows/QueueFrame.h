...
private:
	...
	HTREEITEM fileLists, testsurRoot, flcRoot;
	...
	HTREEITEM addDirectory(const string& dir, bool isFileList = false, HTREEITEM startAt = NULL, bool ts = false, bool fl = false);
	void removeDirectory(const string& dir, bool isFileList = false, bool ts = false, bool fl = false);
...
/**
 * @file
 * $Id: QueueFrame.h 498 2010-05-08 10:49:48Z bigmuscle $
 */
