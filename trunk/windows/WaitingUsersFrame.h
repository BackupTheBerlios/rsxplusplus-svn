...
class WaitingUsersFrame : public MDITabChildWindowImpl<WaitingUsersFrame, TABDEFCLR, IDR_UPLOAD_QUEUE>, public StaticFrame<WaitingUsersFrame, ResourceManager::WAITING_USERS, IDC_UPLOAD_QUEUE>,
...
public:
	...
	typedef MDITabChildWindowImpl<WaitingUsersFrame, TABDEFCLR, IDR_UPLOAD_QUEUE> baseClass;
